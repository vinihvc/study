  ...
  return (
    <AutocompletePrimitive.Portal>
      ...
      >
        <span
          className={cn(
            "relative flex max-h-full origin-(--transform-origin) rounded-md border bg-popover bg-clip-padding shadow-lg/5 transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-md)-1px)] before:shadow-[0_-1px_--theme(--color-white/6%)]",
            className
          )}
        >
